...
public class GenderStatsCols {
    ...
    public static class Series{
        final private static String COL_NAMES = ReadFirstLine.readLine("/GenderStatistics/data/Gender_StatsSeries.csv");
        final private static Entry<StringBuilder,ArrayList<String>> entry = new Cleaning().splitAndClean(COL_NAMES);

...
public class FemaleEducation extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception {
        ...
        jobExtractCodes.setMapperClass(CodeForFemaleEducation.class);
        jobExtractCodes.setOutputKeyClass(Text.class);
        jobExtractCodes.setOutputValueClass(IntWritable.class);

...
public class Q1Test{
    ...
    public void q1TestMap() throws IOException {
        ...
        String testStr = "\"Argentia\",\"ARG\",\"Educational attainment, completed Bachelor\'s or equivalent, population 25+ years, female (%)\",\"SE.TER.HIAT.BA.FE.ZS\",\"1.7\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"2.5\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"5.8\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"11.76038\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"12.77619\",\"\",\"15.26402\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",";
        //String testData = "\"\",\"\",\"\",\"\",\"\",\"\",\"\",";
        String testData = ",,,,,,,";
        ...
        map1.put(new Text("Educational attainment, completed Bachelor\'s or equivalent, population 25+ years, female (%)"),
         new Text("Argentina"));
        
        map2.put(new Text(testData), new IntWritable(1));
        //mapDriver.withOutput(map1, map2);
        ...
        for (Writable key : map1Expect.keySet()) {
          map1keyStr.append(key);
          map1ValStr.append(map1.get(key));

        }
        IntWritable map2Val = null;
        for (Writable key : map2Expect.keySet()) {
            map2keyStr.append(key);
            map2Val = (IntWritable) map1.get(key);
          }

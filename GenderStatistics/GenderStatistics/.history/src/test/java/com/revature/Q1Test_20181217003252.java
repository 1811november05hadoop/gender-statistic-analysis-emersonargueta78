 ...
 */
public class Q1Test{
    MapDriver<LongWritable,Text,MapWritable,Text> mapDriver;
    ...
    public void setUp() {
        ...
        mapDriver = new MapDriver<LongWritable,Text,MapWritable,Text>();
    ...
    public void q1TestMap() throws IOException {
        ...
        List<Pair<MapWritable,Text>> expectedOutput = mapDriver.run();
        ...
        Text textExpect = expectedOutput.get(0).getSecond();
        ...
        boolean[] actuals = {
            ...
            textExpect.toString().equals("2010:,2011:,2012:,2013:,2014:,2015:,2016:,")   
        };

...
public class Q1Test{
    ...
    public void q1TestMap() throws IOException {
        ...
        assertTrue(map1keyStr.toString().equals("Educational attainment, completed Bachelor\'s or equivalent, population 25+ years, female (%)")); 
        assertTrue(map1keyStr.toString().equals("Educational attainment, completed Bachelor\'s or equivalent, population 25+ years, female (%)"));
        boolean[] exepected = {true,true,true,true};

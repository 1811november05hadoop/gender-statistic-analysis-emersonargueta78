...
public class Q2Test{
    ...
    public void q2TestMap() throws IOException {
        ...
        boolean[] actuals = {
            text1Expect.toString().equals("Educational attainment, completed Bachelor\'s or equivalent, population 25+ years, female (%)|United States"),
            text2Expect.toString().equals("0.125"),
        };

...
public class Q1Test{
    ...
    public void q1TestMap() throws IOException {
        ...
        String text1ExpectStr = text1Expect.toString();
        String text2ExpectStr = text2Expect.toString();
        
        boolean[] exepecteds = {true,true};
        boolean[] actuals = {
            text1Expect.toString().equals("Educational attainment, completed Bachelor\'s or equivalent, population 25+ years, female (%)|Argentina"),

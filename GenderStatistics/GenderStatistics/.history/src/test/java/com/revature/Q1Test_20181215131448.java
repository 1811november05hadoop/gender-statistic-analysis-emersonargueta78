...
public class Q1Test{
    ...
    public void q1TestMap() throws IOException {
        ...
        MapWritable ma2 = new MapWritable();
        ...
        MapWritable map1 = expectedOutput.get(0).getFirst();
        MapWritable map2 = expectedOutput.get(0).getSecond();

        for (Writable key : map1.keySet()) {

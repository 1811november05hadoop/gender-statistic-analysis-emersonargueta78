 ...
 */
public class Q1Test{
    MapDriver<LongWritable,Text,MapWritable,IntWritable> mapDriver;
    //ReduceDriver<> reducer;

    @Before
    public void setUp() {
        Q1Mapper mapper = new Q1Mapper();
        mapDriver = new MapDriver<LongWritable,Text,MapWritable,IntWritable>();
        mapDriver.setMapper(mapper);
        new Globals().setYearlyRanges("1960","2016");
    }

 ...
 * Q1Mapper
 */
public class Q3_4Mapper extends Mapper<LongWritable, Text, MapWritable, MapWritable> implements Globals {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String bq1DataVals = new Q3_4Mapper().averageIncrease(dataVals.toString());
    ...
    throws IOException, InterruptedException { 
        ...
        if(
            ...
            && country.contains(patternToMatch[2])
        ){

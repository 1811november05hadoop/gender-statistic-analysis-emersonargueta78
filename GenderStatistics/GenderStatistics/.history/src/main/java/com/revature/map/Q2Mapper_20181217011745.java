...
public class Q2Mapper extends Mapper<LongWritable,Text,Text,Text> implements Globals{
    ...
    throws IOException, InterruptedException {
        ...
        if(
            ...
            && indicatorName.matches(regexes[2])
        ){
            //String bq1DataVals = "";
            ...
            String bq1DataVals = averageIncrease(dataVals.toString(),indicatorName);
    ...
    private String averageIncrease(List<String> colVals,String indicatorName) throws IOException {        
        if(!indicatorName.matches(regexes[1])){
            return "";
        }

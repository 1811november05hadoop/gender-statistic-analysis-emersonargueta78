...
public class Cleaning {
    ...
    public StringBuilder getYearlyColumnVals(ArrayList<String> colVals,Entry<String,String> range) throws IOException {
        StringBuilder retStrBld = new StringBuilder();
        
        Map dataCols = new GenderStatsCols().getDataCols();
        ...
        for(int i = lowerRange; i<upperRange;i++){
            ...
            retStrBld.append(dataCols.get(iStr)+",");    
        }

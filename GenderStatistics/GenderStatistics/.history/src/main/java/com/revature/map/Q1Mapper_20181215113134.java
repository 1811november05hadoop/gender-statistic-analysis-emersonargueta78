...
public class Q1Mapper extends Mapper<LongWritable,Text,MapWritable,MapWritable> {
    ...
    public static String yearLowerRange = "";
    public static String yearUpperRange = "";

    public void setYearlyRanges(Entry<String,String> ranges) {
        yearLowerRange = ranges.getKey();
        yearUpperRange = ranges.getValue();
    }

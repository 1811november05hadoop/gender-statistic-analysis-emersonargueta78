...
public class Q1Mapper extends Mapper<LongWritable,Text,MapWritable,IntWritable> {
    ...
    throws IOException, InterruptedException {
        ...
        Entry<String,String> rangesEntry = new AbstractMap.SimpleImmutableEntry<>(ranges[0], ranges[1]);
        StringBuilder bq1DataVals = new Cleaning().getYearlyColumnVals(colVals, rangesEntry);

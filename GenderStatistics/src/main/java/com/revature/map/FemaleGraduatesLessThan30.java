 ...
 */
public class FemaleGraduatesLessThan30 extends Mapper<LongWritable, Text, Text, Text> {
    ...
    /**
     * This helper method grabs the country and yearly data column values
     * from the Geners_StatsData.csv
     */

...
public class CodeForFemaleGraduation extends Mapper<LongWritable, Text, Text, Text> {
    final private static Logger LOGGER = Logger.getLogger(CodeForFemaleGraduation.class);
    final private static String searchEducationFemaleCodes = new Regex().getRegexes()[0];
    final private static String searchEducationCodes = new Regex().getRegexes()[1];

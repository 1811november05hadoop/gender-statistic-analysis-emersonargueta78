...
public class Q5Test{
    ...
    @Test
    public void q5TestMap() throws IOException {
        ...
        mapDriver.withOutput(new Text("Educational attainment, completed Bachelor\'s or equivalent, population 25+ years, male (%)|Argentina"),

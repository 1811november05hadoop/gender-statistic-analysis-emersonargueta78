...
public class ReadFirstRow {
    ...
    public Map<Integer,String> readFirstRow() throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader("/home/emerson/Repositories/gender-statistic-analysis-emersonargueta78/GenderStatistics/data/Gender_StatsSeries.csv"));

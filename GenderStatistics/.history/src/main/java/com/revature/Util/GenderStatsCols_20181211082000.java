...
public class GenderStatsCols {
    ...
    public static Map<Integer,String> getDataCols() throws IOException {
        ...
        final Map<Integer, String> colNames = new ReadFirstRow().readFirstRow(dataFilePath);
        return colNames;
    }
    
    public static Map<Integer,String> getSeriesCols() throws IOException {

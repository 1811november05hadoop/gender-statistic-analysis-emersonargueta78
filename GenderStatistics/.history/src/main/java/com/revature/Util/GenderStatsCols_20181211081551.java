...
public class GenderStatsCols {
    final private static String dataFilePath = "/home/emerson/Repositories/gender-statistic-analysis-emersonargueta78/GenderStatistics/data/Gender_StatsData.csv";
    final public static Map<Integer,String> colNames = new ReadFirstRow().readFirstRow(dataFilePath);
